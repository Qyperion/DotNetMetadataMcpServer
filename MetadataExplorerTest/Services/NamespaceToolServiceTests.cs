...
public class NamespaceToolServiceTests
{
    ...
    public void GetNamespaces_Pagination_ReturnsCorrectPage()
    {
        ...
        var response1 = _service.GetNamespaces(_testProjectPath, [], [], 1, pageSize);
        var response2 = _service.GetNamespaces(_testProjectPath, [], [], 2, pageSize);
    ...
    public void GetNamespaces_WithInvalidPageNumber_ReturnsEmptyResults()
    {
        ...
        var response = _service.GetNamespaces(_testProjectPath, [], [], invalidPageNumber, 20);
